...
<Note>
Assertions are available on [single-run annotation queues](/langsmith/annotation-queues#single-run-annotation-queues). [Pairwise queues](/langsmith/annotation-queues#pairwise-annotation-queues) are unchanged. Assertions are currently UI-only; the [SDK guide](/langsmith/annotation-queues-sdk) covers programmatic access to feedback configs and queue rubrics, not assertions.
</Note>
