...
Open the [LangSmith UI](https://smith.langchain.com?utm_source=docs&utm_medium=cta&utm_campaign=langsmith-signup&utm_content=langsmith-llm-gateway-quickstart) and navigate to the tracing project named **gateway** in the workspace associated with your API key. You should see a new trace for the call you just made.

If you passed a `Langsmith-Project` header (or the upstream SDK set one), the trace will land in that project.
