...
- **Run interpreter code** with [interpreters](/oss/javascript/deepagents/interpreters) for tool composition, subagent orchestration, and structured data transformations
