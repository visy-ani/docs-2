...
description: Persistent memory, AGENTS.md files, and reusable skills for the Deep Agents CLI including creation, discovery, and invocation.
---
...
<Steps>
    ...
    <Step title="Add optional resources">
        Optionally add additional scripts or other resources to the `test-skill` folder. For more information, see [Examples](/oss/javascript/deepagents/skills#example).
    </Step>
</Steps>
...
<Callout icon="edit">
    [Edit this page on GitHub](https://github.com/langchain-ai/docs/edit/main/src/oss/deepagents/cli/memory-and-skills.mdx) or [file an issue](https://github.com/langchain-ai/docs/issues/new/choose).
</Callout>
</div>
